...
MStatus initializePlugin( MObject obj )
{
	...
	MGlobal::executeCommand(MString("source \"") + plugin.loadPath() + "/LsystemGUI.mel\";", true);
    if (!status) {
	...
	MGlobal::executeCommand(MString("source \"") + plugin.loadPath() + "/LSystemNodeGUI.mel\";", true);
    if (!status) {
